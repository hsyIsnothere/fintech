                    ...
                    <table class="table table-bordered border-dark table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $barang->name }}</td>
                                <td>
                                    <img width="100" height="75" src={{ asset('assets/images/' . $barang->image) }} alt="not found" />
                                </td>
                                <td>{{ $barang->desc }}</td>
                                <td>{{ $barang->price }}</td>
                                <td>{{ $barang->stock }}</td>
                                <td>
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#edit-{{ $barang->id }}">
                                        Edit
                                    </button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="{{ route('menu.delete', ['id' => $barang->id]) }}" type="submit" class="btn btn-primary">Yes</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
