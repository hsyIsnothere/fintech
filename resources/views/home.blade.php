        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card" style="border-radius:15px">
                    <div class="card-header" style="color: white;background-color: #FF416C;font-weight:bold;font-size:20px;border-radius:10px">{{ __('Dashboard') }}
                    </div>
                ...
                <body>
                    ...
                    <div class="sambutan">
                        <h1>Selamat Datang Di Fintech Web</h1>
                    </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                        <div class="card h-fit">
                            <div class="card-body">
                                ...
                                <a href="{{ route('tariktunai') }}" class="top-up-btn">Tarik Tunai</a>
                                <a href="{{ route('transaksi') }}" class="top-up-btn">Kantin</a>
